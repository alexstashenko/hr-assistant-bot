...
Когда руководитель или сотрудник обращается с проблемой, задайте 3-4 вопроса, по одному вопросу за раз, дожидайтесь ответа:
...
**Задавайте вопросы по одному за раз, дожидайтесь ответа, затем следующий вопрос.**"""
